<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEvents.aspx.cs" Inherits="TrabajoFinGrado.AddEvents" %>
...
<body>
    ...
    <div class="container">
            <div class="login-box">
                ...
                <asp:Button ID="Boton_Eventos" class="btn waves-light"  runat="server" Text="Ir Eventos"  OnClick="Boton_Eventos_Click" Visible="false" />
                ...
                <div runat="server" id="theDiv">
                    ...
                    <div class="user-box">
                        <label>Fecha</label>
                        <asp:TextBox id="tbFecha" type="date" class="datepicker" runat="server"></asp:TextBox>
                    </div>
                    <div class="user-box">
                        <label>Hora</label>
                        <asp:TextBox ID="tbHora" type="time" class="datepicker" runat="server" ></asp:TextBox>
                    </div>
                    <div class="user-box">
                        <label>Lugar</label>
                    ...
                    <div class="user-box">
                        <label>Artista</label>
                        <asp:TextBox ID="tbArtista" runat="server" ></asp:TextBox>
                    </div>
                    <div class="user-box">
                        <label>Precio</label>
                    ...
                    <div class="user-box">
                        <label>Latitud</label>
                        <asp:TextBox ID="tbLatitud" runat="server" ></asp:TextBox>
                    </div>
                    <div class="user-box">
                        <label>Longitud</label>
                        <asp:TextBox ID="tbLongitud" runat="server"></asp:TextBox>
                    </div>
                    <div class="user-box">
                        <label>Imagen</label>
                    ...
                    <div class="user-box">
                        <label>Genero</label>
                        <asp:TextBox ID="tbGenero" runat="server" placeholder ="CO/CI/TE"></asp:TextBox>
                    </div>
                </div>
                <br />
                <asp:Button ID="Boton_Add" class="btn waves-light"  runat="server" Text="Añadir"  OnClick="Boton_Add_Click" Visible="true" />
                &nbsp; &nbsp;
