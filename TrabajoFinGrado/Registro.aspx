<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="TrabajoFinGrado.Registro" %>
            ...
            <div class="login-box">
                ...
                <div runat="server" id="theDiv">
                    ...
                    <div class="user-box">
                        ...
                        <asp:TextBox ID="tbPasswordConfirmed" runat="server" type="password"></asp:TextBox>
                    </div>
                    <div class="user-box">
                        <label>Email</label>
