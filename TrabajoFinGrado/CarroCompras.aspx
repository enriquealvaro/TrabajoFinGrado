...
<form runat="server">
    <asp:Button class="delete-button" runat="server" Text="Vaciar Carrito" />
    <%--<asp:Button class="ok-button"  type="submit" runat="server" value="actualizar" Text="Comprar" OnClick="Actualizar_Click" />--%>
